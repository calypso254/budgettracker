      ...
      <div className="border border-[#2D3436] bg-white p-5">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h3 className="mt-2 text-2xl font-bold">Paid vs unpaid total</h3>
          </div>
          <div className="text-right">
            <p className="text-sm text-[#6B777A]">
              {formatAmount(totalPaid)} paid of {formatAmount(totalExpected)}
            </p>
        ...
        <div className="mt-4 h-5 overflow-hidden border border-[#2D3436] bg-[#F0F4F8]">
          <div
            ...
            <div className="mt-5 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-2 text-sm font-medium">
                ...
                <span className="text-[#6B777A]">
                  Latest payment:{' '}
                  {bill.latestPaymentDate ? formatDateLabel(bill.latestPaymentDate) : 'No payment yet'}
                </span>
              </div>
